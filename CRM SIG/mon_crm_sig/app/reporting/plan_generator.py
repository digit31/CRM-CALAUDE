...
def _dessiner_couches(ax, couches, x0, y0, x1, y1, lw, ms):
...
def generer_plan_apd(dossier_shape: str, chemin_pdf: str,
    ...
    _dessiner_couches(ax, couches, x0, y0, x1, y1, lw, ms)
    ...
    blocs = symb.legende_dynamique(couches)
    if blocs:
        leg_w = 58.0
